...
const remove_product = async (id) =>{
  ...
  return (
    <div className="p-2 box-border bg-white mb-0 rounded-sm w-full mt-4 sm:p-4 sm:m-7">
      ...
      <div className="m-h-[77vh] overflow-auto px-4 text-center">
            ...
            <tbody>
              {allProducts.map((product,i) =>(
                <tr className="border-b border-slate-900/20 text-gray-20 p-6 medium-14" key={i}>
                  <td className="flexStart sm:flexCenter"><img className="rounded-lg ring-1 ring-slate-900/5 my-1" height={43} width={43} src={product.image} alt="" /></td>
